              ...
              try {
                ...
                const findings = (result.results ?? []).map((f: unknown) => {
                  ...
                  return {
                    ...
                    cwe: obj['extra'] && typeof obj['extra'] === 'object' && obj['extra'] !== null && 'metadata' in obj['extra'] && typeof (obj['extra'] as Record<string, unknown>)['metadata'] === 'object' && (obj['extra'] as Record<string, unknown>)['metadata'] !== null && 'cwe' in (obj['extra'] as Record<string, unknown>)['metadata'] ? ((obj['extra'] as Record<string, unknown>)['metadata']['cwe']) : undefined,
                    owasp: obj['extra'] && typeof obj['extra'] === 'object' && obj['extra'] !== null && 'metadata' in obj['extra'] && typeof (obj['extra'] as Record<string, unknown>)['metadata'] === 'object' && (obj['extra'] as Record<string, unknown>)['metadata'] !== null && 'owasp' in (obj['extra'] as Record<string, unknown>)['metadata'] ? ((obj['extra'] as Record<string, unknown>)['metadata']['owasp']) : undefined,
                    raw: f
                  };
                }).filter(Boolean);
                for (const finding of findings) {
                  console.log(`[quality][semgrep] Finding: ${finding.check_id} at ${finding.path}:${finding.startLine} - ${finding.extra.message}`);
                }
