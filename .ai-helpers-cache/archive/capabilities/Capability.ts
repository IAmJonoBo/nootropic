...
export interface Capability {
   ...
   */
  // @ts-expect-error TS(2304): Cannot find name 'reload'.
  reload?(): Promise<void>;

  /**
   * Optional: Event hooks for event-driven orchestration and composability.
   */
  // @ts-expect-error TS(2552): Cannot find name 'onEvent'. Did you mean 'Event'?
...
export interface CapabilityDescribe {
   ...
   */
  // @ts-expect-error TS(2304): Cannot find name 'eventSubscriptions'.
  eventSubscriptions?: string[];
  /**
   * Event types/topics the capability emits (for event-driven orchestration).
   */
  // @ts-expect-error TS(2304): Cannot find name 'eventEmissions'.
