...
export class ContentAgent extends BaseAgent {
  ...
  override async runTask(task: unknown, logger?: AgentLogger): Promise<AgentResult> {
    ...
    // @ts-expect-error TS(2304): Cannot find name 'draft'.
  ...
  /**
   * Example stub method for content generation.
   * This method is for internal use only.
   */
  private async contentStub(_: string): Promise<string> {
    void _;
    // TODO: Integrate real content logic
    return '[Content] (stub)';
  }
}
