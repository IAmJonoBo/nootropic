# todo:nootropic/utils/context/shimiMemory.ts:53 (epic)
**Description:** [TODO] // TODO: Plug in real LLM/embedding backend for concept merging (nootropic/utils/context/shimiMemory.ts:53)
**Status:** not started
**Priority:** low
