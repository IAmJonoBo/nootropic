...
**Definition of Done:** All scripts have --help/--json, standardized error handling/output, are referenced in docs, and pass CI checks.
**Tags:** cli, docs-as-code, llm-friendly, automation, discoverability
---
## Metadata
...
- [draft-missing-capability-docs](docs/stories/draft-missing-capability-docs.md)
- [update-onboarding-for-cli-and-registry](docs/stories/update-onboarding-for-cli-and-registry.md)
- [cross-check-backlog-doc-code-drift](docs/stories/cross-check-backlog-doc-code-drift.md)
- [implement-self-auditing-and-self-healing-hooks](docs/stories/implement-self-auditing-and-self-healing-hooks.md)
- [llm-ai-usage-hints-and-schema-output](docs/stories/llm-ai-usage-hints-and-schema-output.md)