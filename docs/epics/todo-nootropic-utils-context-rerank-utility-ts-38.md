# todo:nootropic/utils/context/RerankUtility.ts:38 (epic)
**Description:** [TODO] // TODO: Use bi-encoder for initial ranking, cross-encoder for top-N reranking (nootropic/utils/context/RerankUtility.ts:38)
**Status:** not started
**Priority:** low
