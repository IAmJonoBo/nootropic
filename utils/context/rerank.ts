...
export class RerankUtility implements Capability {
   ...
   */
  async embeddingRerank(_query: string, results: string[], topK: number): Promise<string[]> {
   ...
   * @param topK Number of top results
   */
  async llmRerank(_query: string, results: string[], topK: number): Promise<string[]> {
   ...
   * @param topK Number of top results
   */
  async crossEncoderRerank(_query: string, results: string[], topK: number): Promise<string[]> {
   ...
   * @param topK Number of top results
   */
  async mmrRerank(_query: string, results: string[], topK: number): Promise<string[]> {
