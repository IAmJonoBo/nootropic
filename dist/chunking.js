...
export class ChunkingUtility {
    ...
    sentenceChunking(text, sentencesPerChunk, overlap) {
    ...
    paragraphChunking(text, paragraphsPerChunk, overlap) {
    ...
    async semanticChunking(text, _threshold, overlap) {
    ...
    async recursiveChunking(text, maxChunkSize, overlap) {
    ...
    async agenticChunking(text, _agenticTask, overlap) {
    ...
    async storeChunksInShimi(chunks) {
        if (!this.shimi)
            return;
