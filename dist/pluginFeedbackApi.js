 ...
 */
app.post('/plugin-feedback/:pluginName', async (req, res) => {
 ...
 */
app.get('/plugin-feedback/:pluginName', async (req, res) => {
 ...
 */
app.get('/plugin-feedback/:pluginName/aggregate', async (req, res) => {
