...
import ChunkingUtilityCapability from '../../ChunkingUtility.js';
...
registry.register(new RAGPipelineUtility(publishEvent));
registry.register(new RerankUtility());
registry.register(new ReasoningLoopUtility(publishEvent));
registry.register(ChunkingUtilityCapability);
