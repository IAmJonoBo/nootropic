 ...
 */
export declare class SemgrepMemoriesUtility extends BaseMemoryUtility<SastFeedbackMemory> {
    name: string;
    filePath: string;
     ...
     * Add a feedback/memory entry for a Semgrep finding.
     */
    addSemgrepMemory(findingId: string, memory: Partial<SastFeedbackMemory>): Promise<void>;
    /**
     * List all feedback/memories for a Semgrep finding.
     */
    listSemgrepMemories(findingId: string): Promise<SastFeedbackMemory[]>;
    /**
    ...
    llmTriageSemgrepFinding(finding: {
        id: string;
        severity?: string;
    }, memories?: SastFeedbackMemory[]): Promise<{
        triage: 'true_positive' | 'false_positive' | 'needs_review';
        rationale: string;
        memory?: SastFeedbackMemory;
    }>;
    /**
     ...
     */
    contextAwareTriageSemgrepFinding(finding: {
        id: string;
        severity?: string;
    }, memories?: SastFeedbackMemory[]): Promise<{
        triage: string;
...
export declare const semgrepMemoriesCapability: {
    name: string;
    describe: () => {
        promptTemplates: {
            name: string;
